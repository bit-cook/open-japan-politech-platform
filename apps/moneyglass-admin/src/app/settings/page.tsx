export default function SettingsPage() {
  return (
    <div>
      <div className="mb-8">
        <h2 className="text-2xl font-bold text-admin-text">設定</h2>
        <p className="mt-1 text-sm text-admin-text-muted">管理画面の設定</p>
      </div>
      <div className="flex flex-col items-center justify-center rounded-xl border border-dashed border-admin-border bg-admin-card px-12 py-16 text-center">
        ...
        <h3 className="mb-2 text-lg font-semibold text-admin-text">設定</h3>
