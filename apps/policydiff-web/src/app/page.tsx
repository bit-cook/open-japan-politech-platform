...
import { Badge, Card, HeroSection, Stat } from "@ojpp/ui";
...
export default async function Home() {
  ...
  return (
    <div>
      <HeroSection
        title="すべての政党の政策を、比較できる場所"
        subtitle="PolicyDiffは、各政党の政策をGitで管理し、市民がPull Requestで改善提案できるオープンソースプラットフォームです。特定の政党のためではなく、民主主義のインフラとして。"
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
            {categories.map((cat) => (
              <a
                ...
                className="group rounded-lg border bg-white p-4 shadow-sm transition-all duration-300 hover:scale-[1.02] hover:shadow-lg"
              >
                  ...
                  proposal.status === "OPEN"
                    ...
                    : proposal.status === "ACCEPTED"
                      ...
                      : proposal.status === "REJECTED"
                        ...
                        : "default";
                return (
                  <Card key={proposal.id} padding="sm" hover>
