...
const HOUSE_OF_REPRESENTATIVES_ELECTIONS: ElectionData[] = [
  ...
  },
  {
    ...
    results: [
      ...
      { partyName: "国民新党", seatsWon: 1, districtSeats: 0, proportionalSeats: 1 },
...
const HOUSE_OF_COUNCILLORS_ELECTIONS: ElectionData[] = [
  ...
  },
  {
    ...
    results: [
      ...
      { partyName: "たちあがれ日本", seatsWon: 1, districtSeats: 0, proportionalSeats: 1 },
      { partyName: "新党改革", seatsWon: 1, districtSeats: 0, proportionalSeats: 1 },
    ],
  },
  {
    name: "第23回参議院議員通常選挙",
